...
CREATE TRIGGER "StartScrapingForNewSearches" AFTER INSERT ON public.searches FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://ywonvwjjabizawhmwalz.supabase.co/functions/v1/scrape-start', 'POST', '{"Content-type":"application/json","Authorization":"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl3b252d2pqYWJpemF3aG13YWx6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyNzcxMzUzNiwiZXhwIjoyMDQzMjg5NTM2fQ.gTTzONjBtvZdfx6iSa3V2rjsks8_X4EUzFP_v7jAJDw"}', '{}', '1000');
