...
const startScraping = async (keyword: string, search_id: string) => {
  const searchParams = new URLSearchParams({
    ...
    endpoint: `https://ywonvwjjabizawhmwalz.supabase.co/functions/v1/scrape-complete?id=${search_id}`,
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/scrape-start' \
    ...
    curl -i --location --request POST 'https://ywonvwjjabizawhmwalz.supabase.co/functions/v1/scrape-start' \
    --header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl3b252d2pqYWJpemF3aG13YWx6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mjc3MTM1MzYsImV4cCI6MjA0MzI4OTUzNn0.eJNOGcwFvHOpEbLe-7KQoibGbQZnNRvKmtEt8OW2ahM' \
    --header 'Content-Type: application/json' \
    --data '{"record": {"id": 1, "query": "Iphone"}}'
